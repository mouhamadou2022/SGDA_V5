...
export function AppNav({ userRole, activeModule, onModuleChange }: AppNavProps) {
  ...
  const modules: NavModule[] = [
    ...
    { id: 'aerodromes', label: 'Aérodromes', icon: Plane, roles: ['admin', 'inspector', 'dg_operator', 'focal_operator', 'guest'] },
    { id: 'certification', label: 'Certification', icon: ShieldCheck, roles: ['admin', 'inspector', 'guest'], condition: showCertification },
    { id: 'homologation', label: 'Homologation', icon: Scale, roles: ['admin', 'inspector', 'guest'], condition: showHomologation },
    { id: 'planning', label: 'Planning', icon: CalendarDays, roles: ['admin', 'inspector'] },
    { id: 'surveillance', label: 'Surveillance', icon: Eye, roles: ['admin', 'inspector'] },
    { id: 'plans-actions', label: 'Écarts & PAC', icon: Flame, roles: ['admin', 'inspector'], badge: nbEcartsCritiques, badgeVariant: 'danger' },
    { id: 'registres', label: 'Registres', icon: BookOpen, roles: ['admin', 'inspector'] },
    { id: 'dossiers', label: 'Dossiers', icon: FolderOpen, roles: ['admin', 'inspector', 'guest'] },
    { id: 'formation', label: 'Formation', icon: GraduationCap, roles: ['admin', 'inspector'] },
    ...
    { id: 'risque', label: 'Profil Risque', icon: Activity, roles: ['admin', 'inspector', 'focal_operator', 'staff_operator'] },
    { id: 'charge', label: 'Charge Travail', icon: ListTodo, roles: ['admin', 'inspector'] },
    // ── Modules DG ANACIM (stratégique national) ──
    { id: 'dg-pilotage-securite', label: 'Pilotage Sécurité', icon: Flame, roles: ['dg_anacim'], badge: nbEcartsCritiques, badgeVariant: 'danger' },
    { id: 'dg-conformite-controle', label: 'Conformité & Contrôle', icon: CalendarDays, roles: ['dg_anacim'] },
    { id: 'dg-decisions-impact', label: 'Décisions & Impact', icon: Target, roles: ['dg_anacim'] },
