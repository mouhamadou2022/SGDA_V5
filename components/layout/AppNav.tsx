...
export function AppNav({ userRole, activeModule, onModuleChange }: AppNavProps) {
  ...
  const modules: NavModule[] = [
    ...
    { id: 'dossiers', label: 'Dossiers', icon: FolderOpen, roles: ['admin', 'inspector'] },
    ...
    { id: 'operator-planning', label: 'Mon Planning', icon: ListTodo, roles: ['focal_operator'] },
    { id: 'operator-ecarts', label: 'Écarts & PAC', icon: Flame, roles: ['focal_operator'], badge: nbEcartsCritiques, badgeVariant: 'danger' },
    { id: 'operator-certification', label: 'Certification', icon: ShieldCheck, roles: ['focal_operator'], condition: showOperatorCertification },
    { id: 'operator-homologation', label: 'Homologation', icon: Scale, roles: ['focal_operator'], condition: showOperatorHomologation },
