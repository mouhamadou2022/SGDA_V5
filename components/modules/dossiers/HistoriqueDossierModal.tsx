// components/modules/dossiers/HistoriqueDossierModal.tsx
'use client'

import { useAppStore } from '@/lib/store'
import { X, Plus, Edit3, CheckCircle2, Trash2, Clock, User, FolderOpen, FileText } from 'lucide-react'
      ...
      <div className="modal-content max-w-3xl max-h-[80vh]" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header">
          <div className="modal-title">
            ...
            Historique du dossier {dossier.reference}
          </div>
